...
<%@page import="com.alipay.api.domain.AlipayTradeAppPayModel" %>
...
if(request.getParameter("WIDout_trade_no")!=null){
   ...
   String timeout_express="2m";
    ...
    model.setOutTradeNo("232232323232323");
    ...
    try {
        ...
        System.out.println(alipay_response.getBody());//就是orderString 可以直接给客户端请求，无需再做处理。
        //response.getWriter().write(alipay_response.getBody());
